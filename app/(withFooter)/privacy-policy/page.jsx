      ...
      <div className="max-w-[750px] mx-auto w-full px-4 md:py-[40px] sm:py-[30px] py-[20px]">
        ...
        <div className="2sm:mb-[20px] mb-[12px]">
          ...
          <p className="2sm:text-base text-sm text-gray-800">
            Welcome to Glowist. We value your privacy and are committed to
        ...
        <div className="2sm:mb-[20px] mb-[12px]">
          ...
          <ul className="content-point">
            <li className="2sm:!text-base !text-sm">
              <b className="text-gray-900">Personal Information:</b> When you sign
              up for our newsletter, comment on a post, or contact us, we may
              collect personal information such as your name, email address, and
              any other details you provide.
            </li>
            <li className="2sm:!text-base !text-sm">
              <b className="text-gray-900">Non-Personal Information:</b> We also
              collect non-personal information automatically when you visit our
              site. This includes your IP address, browser type, operating
              system, and the pages you visit on our site.
            </li>
            <li className="2sm:!text-base !text-sm">
              <b className="text-gray-900">Cookies:</b> We use cookies to enhance
              ...
              our services. You can disable cookies through your browser
        ...
        <div className="2sm:mb-[20px] mb-[12px]">
          ...
          <ul className="content-point">
            <li className="2sm:!text-base !text-sm">
              <b className="text-gray-900">To Improve Our Services:</b> We use your
              information to personalize your experience, improve our website,
              and better respond to your individual needs.
            </li>
            <li className="2sm:!text-base !text-sm">
              <b className="text-gray-900">To Send Periodic Emails:</b> The email
              address you provide may be used to send you information, respond
              to inquiries, and other requests or questions.
            </li>
            <li className="2sm:!text-base !text-sm">
              <b className="text-gray-900">To Analyze Site Traffic:</b> We use
              non-personal information to analyze site traffic and understand
              how our users interact with our site.
            </li>
          </ul>
        </div>
        <div className="2sm:mb-[20px] mb-[12px]">
